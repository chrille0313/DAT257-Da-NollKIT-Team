...
#for hit_number in range(5):
    #print(request_data[hit_number])
    #print(request_data[hit_number].image)
    #print(request_data[hit_number].yields)
    #print(request_data[hit_number].calories)
    #print(request_data[hit_number].totalCO2Emissions)